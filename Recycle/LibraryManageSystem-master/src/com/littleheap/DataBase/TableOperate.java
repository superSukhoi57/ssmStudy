...
public class TableOperate {
	...
	public TableOperate() {
		try{
            ...
            conn = DriverManager.getConnection(Information.JDBC_URL,Information.username,Information.password);
            if(conn!=null){
    ...
    public static boolean isExist_Customer(String user,String password) {
    	try{
            ...
            System.out.println(Information.JDBC_URL);
            System.out.println(Information.username);
            System.out.println(Information.password);

            Connection conn = DriverManager.getConnection(Information.JDBC_URL,Information.username,Information.password);
